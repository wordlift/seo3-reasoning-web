...
\texttt{llms.txt} style, and an embedded JSON-LD block---yielding a +80.8\%
accuracy improvement in our experiment.}
...
while C6 (enhanced entity pages + agentic RAG) follows links to
related entities and retrieves comprehensive structured data (5/5).}
